    ...
    >
      <Routes>
        ...
        <Route path="/survey-creator-dashboard/*" element={<SurveyCreatorDashboard />}>
          ...
          <Route path="my-surveys/create-new-survey/custom-templates/preview-custom-survey" element={<SurveyPreviewPage />} />
          <Route path="manage-questions" element={<SurveyCreatorManageQuestions />} />
          <Route path="schedule-surveys" element={<SurveyCreatorScheduleSurveys />} />
          {/* <Route path="share-survey" element={<SurveyCreatorShareSurvey />} /> */}
          <Route path="share-survey" element={<SurveyCreatorDistribution/>}></Route>
